...
friends_graph = {"Анна": ["Борис", "Виктор", "Дарья"],
     "Борис": ["Анна", "Виктор"],
...
def search(name, friends_graph):
    return(friends_graph[name])


def chek(name1, name2, friends_graph):
    return True if name2 in friends_graph[name1] else False


def search_lonely(friends_graph):
    s = []
    for i in friends_graph.keys():
